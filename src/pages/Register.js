...
const Register = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexWrap: 'wrap', p: 5, border: '1px solid red' }}>
            <Box>
                <Button sx={{ mb: 6 }}
                    variant="outlined"
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', border: '1px solid red', gap : 3 }}>
                {/*Content Left */}
                <Box sx={{ justifyContent: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column', mt: 2, width: '30%'}}>
